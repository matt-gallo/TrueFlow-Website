        ...
        <article className="max-w-4xl mx-auto px-6 py-12">
          <motion.header initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <span className="text-white/40 text-sm">July 26, 2026</span>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 md:p-12">
            <div className="prose prose-lg prose-invert max-w-none">
              <p className="text-white/80 leading-relaxed mb-6">Every automation agency has a first-call script. Most of them are a version of &ldquo;tell us what you want to build, and we&apos;ll build it.&rdquo; Ours runs the other direction. Before we touch a workflow, we run the same five-part conversation with every client &mdash; and it usually ends with a smaller build than the one they walked in wanting.</p>
              <p className="text-white/80 leading-relaxed mb-6">Here it is, unedited. Steal it. If your vendor won&apos;t have this conversation with you, that tells you something.</p>
              <h2 className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent mt-10 mb-4">1. &ldquo;Show us the version of this that&apos;s already half-working.&rdquo;</h2>
              <p className="text-white/80 leading-relaxed mb-6">Nobody starts from zero. A clinic operator we sat with last week was sure she needed a brand-new intake system. She already had one &mdash; buried inside a tool she was paying for and using at a fraction of what it could do. Most of the &ldquo;new build&rdquo; was switching on things she already owned. We look for the half-working version first, because building next to it is faster, cheaper, and doesn&apos;t add a sixth login to a stack that already has five.</p>
              <h2 className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent mt-10 mb-4">2. &ldquo;What happens if we delete this instead of automating it?&rdquo;</h2>
              <p className="text-white/80 leading-relaxed mb-6">This is the question almost every agency skips, because deleting doesn&apos;t bill. A lot of the work owners want automated shouldn&apos;t exist at all &mdash; a report nobody reads, a step someone added in 2021 for a reason no one remembers. Automating a useless task just makes you produce useless output faster. We ask the delete question on every item before we ask the automate question. Sometimes the whole project collapses into &ldquo;stop doing three of these five things,&rdquo; and that&apos;s a good day.</p>
              <h2 className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent mt-10 mb-4">3. &ldquo;Whose tool are we living inside?&rdquo;</h2>
              ...
              <h2 className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent mt-10 mb-4">4. &ldquo;What&apos;s the outcome &mdash; in a number you already track?&rdquo;</h2>
              <p className="text-white/80 leading-relaxed mb-6">Not &ldquo;save time.&rdquo; Not &ldquo;be more efficient.&rdquo; A number that already lives in your business: no-show rate, leads that never got a second touch, days-to-quote. If we can&apos;t tie the build to a number you already watch, we&apos;re selling you activity &mdash; and activity is the thing you&apos;re already drowning in. Outcomes are checkable. &ldquo;Feels more organized&rdquo; is not.</p>
              <h2 className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent mt-10 mb-4">5. &ldquo;What breaks when it breaks &mdash; and who notices?&rdquo;</h2>
              <p className="text-white/80 leading-relaxed mb-6">Every automation fails eventually. The only question is whether it fails loud or fails silent. We don&apos;t ship anything without deciding, out loud, what the failure looks like and who gets pinged when it happens. An automation that quietly stops is worse than no automation, because you&apos;ve stopped watching the thing it used to do for you.</p>
              <h2 className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent mt-10 mb-4">Why this is the whole game</h2>
              <p className="text-white/80 leading-relaxed mb-6">None of this is modesty. It&apos;s economics. The over-tooled, under-systematized business &mdash; five subscriptions, no system &mdash; doesn&apos;t need a sixth thing. It needs someone willing to subtract before they build. We call the sequence the Pre-Build Conversation, and we run it in order: find what&apos;s half-working, try to delete it, stay inside your tools, tie it to a real number, and decide how it fails. Most projects get smaller. The ones that survive actually hold.</p>
              <p className="text-white/80 leading-relaxed mb-6">Here&apos;s the part another agency would argue with: we turn down more build requests on the first call than we accept. Not because the work is hard &mdash; because most of it shouldn&apos;t be built. The businesses that scale aren&apos;t the ones with the most automations. They&apos;re the ones with the fewest moving parts doing the most work.</p>
              <p className="text-white/80 leading-relaxed mb-6">Before you pay anyone to build you an automation, run their answers through these five questions. If they can&apos;t tell you what to delete, what number it moves, and how it fails &mdash; they&apos;re selling you activity, not outcomes.</p>
              <p className="text-white/50 text-sm italic mt-8">Based on TrueFlow&apos;s own client build conversations, July 2026.</p>
            </div>
          </motion.div>
