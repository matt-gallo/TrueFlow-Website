    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative z-10">
        ...
        <article className="max-w-4xl mx-auto px-6 py-12">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
                Stop Duct-Taping Your Business Together with 7 Different Platforms
              </span>
            </h1>
            ...
            <div className="flex justify-center gap-4 mb-8 flex-wrap">
              <a
                href={`https://twitter.com/intent/tweet?text=${encodeURIComponent("Stop Duct-Taping Your Business Together with 7 Different Platforms.\n\nEvery disconnected tool is a gap where deals die. Here's what happens when you collapse everything into one automated system.\n\n#BusinessAutomation #TrueFlowAI")}&url=${encodeURIComponent(typeof window !== 'undefined' ? window.location.href : '')}`}
                target="_blank"
              ...
              <a
                href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(typeof window !== 'undefined' ? window.location.href : '')}&summary=${encodeURIComponent("Every new tool you add creates a gap. A gap between where information lives and where decisions get made. And those gaps are where deals die. Here's what one consolidated system actually looks like.")}&title=${encodeURIComponent("Stop Duct-Taping Your Business Together | TrueFlow AI")}`}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(typeof window !== 'undefined' ? window.location.href : '')}&quote=${encodeURIComponent("Stop Duct-Taping Your Business Together with 7 Different Platforms.\n\nEvery disconnected tool is a gap where deals die.\n\n#BusinessAutomation #SystemConsolidation")}`}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <button
                onClick={() => {
                  const shareText = "Stop Duct-Taping Your Business Together with 7 Different Platforms.\n\nEvery new tool you add creates a gap — and those gaps are where deals die. Here's what a consolidated, automated system actually looks like.\n\n#BusinessAutomation #TrueFlowAI"
          ...
          >
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <p className="text-lg leading-relaxed mb-6 text-white/80">
                You&apos;ve got Salesforce for contacts. A spreadsheet for inventory. Gmail for follow-ups. A separate tool for forms. Another for document signing. Maybe a whiteboard somewhere with your &quot;sales process&quot; scribbled on it.
              </p>

              <p className="text-lg leading-relaxed mb-8 text-white/80">
                And somehow, you&apos;re supposed to grow.
              </p>

              <p className="text-lg leading-relaxed mb-8 text-white/80">
                Here&apos;s the truth nobody tells you when you&apos;re buying software: every new tool you add creates a gap. A gap between where information lives and where decisions get made. And those gaps? They&apos;re where deals die.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-8 text-white/80">
                No copying and pasting. No &quot;did someone follow up on that?&quot; No spreadsheets that are three days out of date.
              </p>

              <p className="text-lg leading-relaxed mb-8 text-white/80">
                This week, we migrated an entire sales operation off a legacy CRM and into a unified system — complete with automated lead intake, a sales stage engine that moves deals forward based on real actions, inventory tracking, purchase agreement workflows, and internal notifications that keep the whole team aligned. What used to take five platforms and a dozen manual steps now runs on one.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6 text-white/80">
                The biggest objection we hear is: &quot;We&apos;ve been using our current system for years. Migrating feels risky.&quot;
              </p>

              <p className="text-lg leading-relaxed mb-6 text-white/80">
                Fair. But here&apos;s the question you should be asking: what&apos;s the cost of staying?
              </p>
              ...
              <p className="text-lg leading-relaxed mb-8 text-white/80">
                The process doesn&apos;t have to be painful, either. We import your contacts, rebuild your sales flow with automation baked in from day one, and train your team on a system that actually works together. Most clients are live within days, not months.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-6 text-white/80">
                When everything runs through one system, something shifts. You stop managing tools and start managing growth. Your team stops asking &quot;where do I find this?&quot; and starts closing. You see your pipeline in real time — not in a report someone pulls once a week.
              </p>

              <p className="text-lg leading-relaxed mb-6 text-white/80">
                That&apos;s not a technology upgrade. That&apos;s an operational upgrade. And it&apos;s the difference between a business that survives and one that scales.
              </p>

              <p className="text-lg leading-relaxed mb-8 text-white/80">
                If your sales process currently requires you to log into four platforms before lunch, that&apos;s not a workflow. That&apos;s a workaround. And workarounds don&apos;t scale.
              </p>
              ...
              <p className="text-lg leading-relaxed mb-8 text-white">
                <strong>Want this built for you in just 3 days — for free — and you don&apos;t pay until you see traction?</strong> Take the free AI Readiness Assessment below to see exactly where your business is leaking time and money — and whether you qualify.
              </p>
          ...
          >
            <h2 className="text-3xl font-bold mb-4">Find Out Where Your Business Is Leaking Time and Money</h2>
