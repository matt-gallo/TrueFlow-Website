/**
 * TrueFlow Growth Audit Page
 * Ad-traffic landing page: "Stop Losing Leads You Already Paid For"
 */
...
const systemBlocks: SystemBlock[] = [
  {
    id: 'lead-capture',
    title: 'Lead Capture',
    description: 'Every lead from your website, ads, forms, social media, chat, and referrals enters one centralized system.',
    icon: Inbox,
  ...
  },
  {
    ...
    description: 'The moment a lead reaches out, they receive an immediate response. 24 hours a day. 7 days a week. 365 days a year.',
    icon: BellRing,
    gradientFrom: 'from-green-500',
    gradientTo: 'to-emerald-500',
    bullets: [
      'Respond in seconds, not hours or days',
      'Beat competitors to every inbound lead',
      'Never let interest go cold'
    ]
  },
  {
    id: 'qualification',
    title: 'Automated Qualification',
    description: 'Not every lead deserves your team’s attention. Our AI systems qualify prospects automatically.',
    icon: Filter,
    gradientFrom: 'from-purple-500',
    gradientTo: 'to-pink-500',
    bullets: [
      'Your sales team focuses on the highest-value opportunities',
      'Low-fit leads handled without burning rep time',
      'Qualification logic built around your offer'
    ]
  },
  {
    id: 'appointment-booking',
    title: 'Appointment Booking',
    description: 'Qualified prospects book directly into your calendar.',
    icon: Calendar,
  ...
  },
  {
    ...
    description: 'Most sales happen after multiple touchpoints. Yet most businesses quit too early.',
    icon: Repeat,
    gradientFrom: 'from-orange-500',
    gradientTo: 'to-red-500',
    bullets: [
      'Automatic follow-up across email, SMS, voicemail, and more',
      'Continues until prospects either buy or opt out',
  ...
  },
  {
    ...
    description: 'Your pipeline stays clean. Opportunities stay organized.',
    icon: Database,
    gradientFrom: 'from-indigo-500',
    gradientTo: 'to-purple-500',
    bullets: [
      'Your team always knows where every prospect stands',
  ...
  },
  {
    ...
    description: 'Know exactly what is working — no guessing, no assumptions, just data.',
    icon: BarChart3,
    ...
    bullets: [
      ...
      'Which follow-up sequences convert',
      'Where opportunities are leaking'
    ]
  }
]
...
export default function GrowthAuditPage() {
  ...
  const painPoints = [
    ...
    'Sales reps forget opportunities',
    'CRM records become outdated',
    'Prospects disappear after showing interest',
  ...
  const fitFor = [
    ...
    'Businesses generating consistent leads'
  ]

  const notFitFor = [
    'Businesses with no existing demand',
    'Early-stage startups searching for product-market fit',
    'Companies unwilling to implement systems',
    'DIY operators looking for software only'
  ]
  ...
  const auditFinds = [
    ...
    'Revenue opportunities hiding inside your existing process'
  ]

  const faqs = [
    {
      question: 'Do I need a CRM already?',
      answer: 'No. We can build the entire infrastructure from scratch or improve what already exists.'
    },
    {
      question: 'Will this replace my sales team?',
      answer: 'No. It helps your sales team become dramatically more efficient.'
    },
    {
      question: 'How long does implementation take?',
      answer: 'Most systems are implemented within a few weeks depending on complexity.'
    },
    {
      question: 'Do you provide ongoing support?',
      answer: 'Yes. Ongoing optimization is one of the biggest reasons clients work with us.'
    },
    {
      question: 'Is this only for large companies?',
      answer: 'No. Many growing businesses benefit the most because they typically have the largest operational gaps.'
    }
  ]
  ...
  return (
    <>
          ...
          <div className="text-center space-y-6 sm:space-y-8">
            <div>
              ...
              <p className={`text-base sm:text-lg md:text-xl max-w-3xl mx-auto mb-6 sm:mb-8 px-4 ${
                ...
                We build and manage the entire AI-powered sales system that turns more leads into booked appointments and customers — so opportunities stop slipping through the cracks.
              </p>
            </div>
          </div>
              ...
              <div className="flex flex-col lg:flex-row items-stretch gap-6 lg:gap-10">
                <div className="lg:w-5/12 flex flex-col justify-center space-y-4 text-left">
                  ...
                  <p className={`text-lg leading-relaxed ${isDarkMode ? 'text-white/70' : 'text-gray-600'}`}>
                    Before discussing whether we&apos;re a fit, we&apos;ll identify where leads are being lost, where follow-up breaks down, and the revenue hiding inside your existing process. You&apos;ll leave the call with clarity on what is costing your business money right now — whether we work together or not.
                  </p>
                </div>
      ...
      <section className={`py-16 sm:py-20 px-4 relative ${
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className={`text-xl sm:text-2xl font-semibold ${isDarkMode ? 'text-white/90' : 'text-gray-800'}`}>
            They need a better system for converting the leads they already have.
          </p>
          <p className={`text-lg sm:text-xl max-w-3xl mx-auto ${isDarkMode ? 'text-white/70' : 'text-gray-600'}`}>
            TrueFlow installs, manages, and optimizes your entire lead capture, follow-up, appointment booking, and customer nurturing system so opportunities stop slipping through the cracks.
          </p>
        </div>
      </section>
      ...
      {/* Pain Section - Every Missed Lead */}
      <section className={`py-16 sm:py-20 px-4 relative ${
        ...
        <div className="max-w-4xl mx-auto">
          <div className={`backdrop-blur-md rounded-3xl p-8 sm:p-12 border shadow-2xl ${
            ...
            <p className={`text-lg text-center mb-8 ${isDarkMode ? 'text-white/70' : 'text-gray-600'}`}>
              You spend money on ads. You generate referrals. People visit your website. Prospects fill out forms. Then what happens? Most businesses lose revenue because:
            </p>
            ...
            <p className={`text-lg sm:text-xl text-center mt-8 ${isDarkMode ? 'text-white/80' : 'text-gray-700'}`}>
              Thousands of dollars in lost revenue every month. Not because demand is missing.
              <br />
              <span className="font-bold bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
                Because systems are missing.
              </span>
            </p>
          </div>
        </div>
      ...
      <section className={`py-16 sm:py-20 px-4 relative ${
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className={`text-lg sm:text-xl text-center mb-10 ${
            ...
            Studies consistently show that the businesses who respond first win most of the business. But here&apos;s what usually happens:
          </p>
          ...
          <div className={`backdrop-blur-md rounded-3xl p-8 sm:p-12 border shadow-2xl mb-8 ${
            ...
            <div className="space-y-3">
              {[
                'Lead comes in.',
                'Someone plans to call later.',
                'The day gets busy.',
                'The lead goes cold.',
                'A competitor responds first.',
                ...
                <div key={index} className="flex items-center space-x-3">
                  ...
                  <p className={`text-lg ${isDarkMode ? 'text-white/80' : 'text-gray-700'}`}>{line}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <p className={`text-lg sm:text-xl text-center ${isDarkMode ? 'text-white/80' : 'text-gray-700'}`}>
            You already paid for the lead. Now you&apos;re paying again to replace them.
            <br />
            <span className="font-bold bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
      ...
      {/* Software Doesn't Solve This Problem */}
      <section className={`py-16 sm:py-20 px-4 relative ${
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className={`text-lg sm:text-xl text-center mb-8 ${
            ...
            Most businesses already own software:
          </p>
          ...
          <p className={`text-lg sm:text-xl text-center mb-4 ${isDarkMode ? 'text-white/70' : 'text-gray-600'}`}>
            The problem isn&apos;t having tools. The problem is having to become a systems architect, automation specialist, CRM manager, copywriter, and marketer just to make them work together.
          </p>
          <p className={`text-lg sm:text-xl text-center ${isDarkMode ? 'text-white/80' : 'text-gray-700'}`}>
            Software wasn&apos;t supposed to create more work.
            <br />
            <span className="font-bold bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
              But for many businesses, that&apos;s exactly what happened.
            </span>
          </p>
        </div>
      </section>

      {/* That's Where TrueFlow Comes In */}
      <section className={`py-16 sm:py-20 px-4 relative ${
        isDarkMode ? 'bg-black' : 'bg-white'
      }`}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className={`text-lg sm:text-xl max-w-3xl mx-auto mb-8 ${
            ...
            We don&apos;t sell software. We build and manage the entire system for you. Instead of giving you another platform to learn:
          </p>
          ...
          <div className="grid sm:grid-cols-2 gap-4 max-w-3xl mx-auto text-left">
            {[
              ...
              'We create the workflows',
              'We manage the automation',
              'We optimize the performance',
              'We continue improving the system over time'
            ].map((item, index) => (
          ...
          <p className={`text-lg sm:text-xl mt-10 ${isDarkMode ? 'text-white/80' : 'text-gray-700'}`}>
            ...
            <br />
            <span className="font-bold bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
              We focus on making sure opportunities never get lost.
            </span>
          </p>
        </div>
      </section>
      ...
      {/* The TrueFlow Growth System - System Blocks */}
      <section className={`py-16 sm:py-20 px-4 relative ${
        isDarkMode ? 'bg-gradient-to-b from-gray-900 to-black' : 'bg-gradient-to-b from-gray-50 to-white'
      }`}>
      ...
      <section className={`py-16 sm:py-20 px-4 relative ${
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className={`backdrop-blur-md rounded-3xl p-8 sm:p-12 border shadow-2xl ${
            ...
            <div className="space-y-3">
              {[
                'A lead submits a form at 11:47 PM.',
            ...
            <p className={`text-lg sm:text-xl text-center mt-8 ${isDarkMode ? 'text-white/80' : 'text-gray-700'}`}>
              ...
              <br />
              <span className="font-bold bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
                That&apos;s what modern sales infrastructure looks like.
              </span>
            </p>
          </div>
        </div>
      ...
      <section className={`py-16 sm:py-20 px-4 relative ${
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Fit */}
            <div className={`backdrop-blur-md rounded-3xl p-8 border shadow-xl ${
              isDarkMode ? 'bg-white/5 border-white/10' : 'bg-white border-gray-200 shadow-lg'
            }`}>
              ...
              <ul className="space-y-4">
                {fitFor.map((item, index) => (
                  <li key={index} className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 mt-0.5 flex-shrink-0 text-green-400" />
                    <span className={`text-lg ${isDarkMode ? 'text-white/80' : 'text-gray-700'}`}>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className={`backdrop-blur-md rounded-3xl p-8 border shadow-xl ${
              ...
              <h3 className={`text-2xl font-bold mb-6 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                We are usually NOT a fit for:
              </h3>
              <ul className="space-y-4">
                {notFitFor.map((item, index) => (
                  <li key={index} className="flex items-start space-x-3">
                    <XIcon className="h-6 w-6 mt-0.5 flex-shrink-0 text-red-400" />
                    <span className={`text-lg ${isDarkMode ? 'text-white/80' : 'text-gray-700'}`}>{item}</span>
                  </li>
                ))}
              </ul>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className={`backdrop-blur-md rounded-3xl p-8 sm:p-12 border shadow-2xl mb-8 ${
            ...
            <div className="space-y-3 text-left max-w-2xl mx-auto">
              {[
                'Most agencies build systems. Then leave.',
                'Most consultants give advice. Then leave.',
                'Most software companies sell access. Then leave.'
              ].map((line, index) => (
                <p key={index} className={`text-lg ${isDarkMode ? 'text-white/70' : 'text-gray-600'}`}>{line}</p>
              ))}
            </div>

            <p className={`text-3xl font-bold mt-8 mb-6 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
              <span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
                We stay.
              </span>
            </p>
            ...
            <p className={`text-lg ${isDarkMode ? 'text-white/70' : 'text-gray-600'}`}>
              Our team continuously manages, improves, and optimizes the system after implementation. Because a sales system isn&apos;t something you install once. It&apos;s something you improve forever.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className={`py-16 sm:py-20 px-4 relative ${
        ...
        <div className="max-w-4xl mx-auto">
          <div className={`backdrop-blur-md rounded-3xl p-8 sm:p-12 border shadow-2xl ${
            ...
            <p className={`text-lg text-center mb-8 ${isDarkMode ? 'text-white/70' : 'text-gray-600'}`}>
              Before discussing whether we&apos;re a fit, we&apos;ll identify:
            </p>
            ...
            <p className={`text-lg text-center mb-8 ${isDarkMode ? 'text-white/80' : 'text-gray-700'}`}>
              You&apos;ll leave the call with clarity on what is costing your business money right now — whether we work together or not.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <p className={`text-lg sm:text-xl lg:text-2xl max-w-4xl mx-auto px-4 transition-all duration-1000 ${
              ...
              See how business owners turned more of the leads they already had into booked appointments and customers.
            </p>
          </div>
      ...
      <section className={`py-20 sm:py-24 px-4 relative ${
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className={`text-lg sm:text-xl mb-10 max-w-2xl mx-auto ${
            ...
            You already paid for the leads. Let&apos;s make sure more of them become customers.
          </p>
