...
const solutionProducts: SolutionProduct[] = [
  {
    ...
    bullets: [
      ...
      'Full CRM & Pipeline Management - track every buyer, seller, and deal without losing anyone',
      'Email & SMS Automation - nurture leads and clients automatically throughout the sales cycle',
      'Reputation Management - collect 5-star reviews from satisfied clients',
      'Analytics & Reporting - know exactly what\'s working (lead sources, conversion rates, deals closed)'
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      'Smart scheduling - prospects book property viewings and consultations directly into your calendar',
      'Instant responses to common questions about listings, neighborhoods, and buying/selling process',
      'Qualify buyers and sellers automatically before they reach you'
    ],
    hook: 'Prospects visit your site but leave without booking because no one\'s there to help them.',
    story: 'Our AI agents are trained on your real estate business and available round-the-clock. They answer questions about listings, qualify prospects, and book consultations directly into your calendar while you sleep.',
    offer: 'AI agents that work 24/7 to capture and qualify leads, turning website visitors into booked consultations.',
    offerHighlights: ['Custom AI training on your listings and area', '24/7 lead capture and qualification', 'Direct calendar integration'],
    ctaHref: '/sign-up'
  },
  {
    id: 'content-engine',
  ...
  },
  {
    ...
    name: 'Lead Machine™',
    title: 'Lead Machine™',
    description: "Finds new buyers and sellers for you with targeted outreach done right.",
    icon: Users,
  ...
  const features = [
    {
      ...
      description: "We build systems that capture every buyer and seller inquiry and follow up automatically. Text, email, or call - your prospects hear back fast, even when you're showing properties.",
    ...
    },
    {
      ...
      title: "24/7 Buyer & Seller Communication",
      description: "Answer common questions about listings, neighborhoods, and the buying/selling process. Update clients automatically throughout their journey. Give great service without lifting a finger.",
    ...
    },
    {
      ...
      description: "Automatic property showing scheduling, confirmations, and reminders reduce no-shows. Keep your calendar full without the back-and-forth.",
    ...
    },
    {
      ...
      description: "We create and post content that brings in new clients. Stay top-of-mind in your market without spending hours on Facebook and Instagram.",
          ...
          <div className="text-center space-y-6 sm:space-y-8">
            <div>
              <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 mt-8 sm:mt-12 leading-tight px-2 ${
                ...
                Add 10 new clients per month on autopilot
              </h1>

              <p className={`text-base sm:text-lg md:text-xl max-w-3xl mx-auto mb-6 sm:mb-8 px-4 ${
                isDarkMode ? 'text-white/60' : 'text-gray-600'
              }`}>
                Done-for-you CRM, automated follow-up, scheduling, and marketing systems built for real estate agents - so every lead turns into a booked consultation without agent involvement.
              </p>
          ...
          <div className={`backdrop-blur-md rounded-3xl p-8 sm:p-12 border shadow-2xl ${
            ...
            <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-12 text-center leading-tight ${
              ...
              <span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
                Every missed follow-up is lost commission revenue you already paid for
              </span>
            </h2>
            ...
            <div className="grid gap-4 sm:gap-6 max-w-3xl mx-auto">
              {[
                ...
                "Leads book showings… then no-show.",
                "Buyers fill out contact forms… then disappear.",
                "Messages sit unanswered while you're showing properties.",
                "Slow follow-up costs closed deals."
              ].map((point, index) => (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            ...
            <p className={`text-lg md:text-xl mb-8 max-w-3xl mx-auto ${
              ...
              Book a demo to see how we handle setup, management, and optimization while you stay focused on closing deals and serving clients.
            </p>
            <button
              onClick={() => setIsDemoModalOpen(true)}
