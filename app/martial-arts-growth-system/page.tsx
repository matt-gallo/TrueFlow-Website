...
const solutionProducts: SolutionProduct[] = [
  {
    ...
    bullets: [
      'Trial class and intro lesson capture from forms, ads, chat, website, and DMs.',
      'Full CRM & Pipeline Management - track students, belt progress, and never lose a trial student again',
      'Email & SMS Automation - nurture trial students, current students, and parents automatically',
      'Reputation Management - collect 5-star studio reviews',
      'Analytics & Reporting - know exactly what\'s working (enrollment, belt promotions, retention)'
    ],
  ...
  },
  {
    ...
    bullets: [
      'AI Chat Agents - book intro lessons 2-3x faster, 24/7',
      'Smart scheduling - prospects book trial classes directly into your calendar',
      'Instant responses to common questions about classes, belt ranks, and schedules',
      'Qualify trial students automatically before they reach you'
    ],
    hook: 'Prospects visit your site but leave without booking because no one\'s there to help them.',
    story: 'Our AI agents are trained on your martial arts studio and available round-the-clock. They answer questions, qualify prospects, and book intro lessons directly into your calendar while you sleep.',
    offer: 'AI agents that work 24/7 to capture and qualify trial students, turning website visitors into booked intro lessons.',
    offerHighlights: ['Custom AI training on your studio', '24/7 trial student capture and qualification', 'Direct calendar integration'],
    ctaHref: '/sign-up'
  },
  {
    id: 'content-engine',
  ...
  },
  {
    ...
    name: 'Lead Machine™',
    title: 'Lead Machine™',
    description: "Finds new students for you with targeted outreach done right.",
    icon: Users,
...
export default function LandingPage() {
  ...
  const features = [
    {
      ...
      title: "Never Miss a Trial Student Again",
      description: "We build systems that capture every trial class and intro lesson and follow up automatically. Text, email, or call - your prospects hear back fast, even when you're teaching on the mat.",
    ...
    },
    {
      ...
      title: "24/7 Student & Parent Communication",
      description: "Answer common questions about classes, belt requirements, and schedules for students and parents. Update everyone automatically. Give great service without lifting a finger.",
    ...
    },
    {
      ...
      description: "Automatic intro lesson scheduling, confirmations, and reminders reduce no-shows. Keep your class schedule full without the back-and-forth.",
    ...
    },
    {
      ...
      description: "We create and post content that brings in new students. Stay top-of-mind without spending hours on Facebook and Instagram.",
  ...
  const testimonials = [
    {
      name: "Master Kim",
      role: "Owner, Elite Taekwondo Academy",
      company: "",
      tier: "Enterprise",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
      quote: "I struggled to follow up with trial students, track belt promotions, and manage parent communication. With TrueFlow's AI-driven lead capture, integrated scheduling, and automatic parent notification system, more trial classes get booked and student onboarding is smoother. The backend now works like it should.",
      results: ["More trial classes booked", "Smoother student onboarding", "Automated parent communication"]
    },
    {
      name: "Sensei Rodriguez",
      role: "Owner, Victory Brazilian Jiu-Jitsu",
      company: "",
      tier: "Enterprise Client",
      image: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?w=150&h=150&fit=crop&crop=face",
      quote: "Before TrueFlow, our website was getting traffic, but visitors weren't turning into booked intro lessons. We rebuilt the site, added AI-driven conversations, and automated follow-up. Without running ads, the system booked 13 intro lessons from organic traffic alone. Now that it works, we're confidently scaling with ads and social.",
      results: ["13 intro lessons booked organically", "AI engaging prospects 24/7", "Website → conversation → booking, automated"]
    },
    {
      name: "Coach Martinez",
      role: "Owner, Dragon MMA & Fitness",
      company: "",
      tier: "Enterprise Client",
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
      quote: "Before TrueFlow, we were generating leads but the system wasn't keeping up. Messages from parents went unanswered, conversations stalled, and follow-up depended on manual effort. We activated AI agents in our DMs and SMS to qualify and respond instantly. Now about 15% of inbound leads are automatically qualified and booked into trial classes, even while running paid ads.",
          ...
          <div className="text-center space-y-6 sm:space-y-8">
            <div>
              <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 mt-8 sm:mt-12 leading-tight px-2 ${
                ...
                Add 10 new students per month on autopilot
              </h1>

              <p className={`text-base sm:text-lg md:text-xl max-w-3xl mx-auto mb-6 sm:mb-8 px-4 ${
                isDarkMode ? 'text-white/60' : 'text-gray-600'
              }`}>
                Done-for-you CRM, automated follow-up, scheduling, and marketing systems built for martial arts studios and dojos - so every lead turns into a booked intro lesson without owner involvement.
              </p>
          ...
          <div className={`backdrop-blur-md rounded-3xl p-8 sm:p-12 border shadow-2xl ${
            ...
            <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-12 text-center leading-tight ${
              ...
              <span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
                Every missed follow-up is lost enrollment revenue you already paid for
              </span>
            </h2>
            ...
            <div className="grid gap-4 sm:gap-6 max-w-3xl mx-auto">
              {[
                ...
                "You already have referrals and DMs.",
                "Leads book… then no-show.",
                "Trial students fill out forms… then disappear.",
                "Messages from parents sit unanswered while you're teaching.",
                "Slow follow-up costs new enrollments."
              ].map((point, index) => (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            ...
            <p className={`text-lg md:text-xl mb-8 max-w-3xl mx-auto ${
              ...
              Book a demo to see how we handle setup, management, and optimization while you stay focused on teaching and running your studio.
            </p>
            <button
              onClick={() => setIsDemoModalOpen(true)}
              ...
              <div className={`relative flex gap-6 p-6 rounded-2xl border ${
                ...
                <div className="flex-1">
                  ...
                  <h4 className={`text-xl font-bold mb-2 ${
                    ...
                    You See Where Every Trial Student Goes
                  </h4>
