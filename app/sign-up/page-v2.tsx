...
export default function SignUpPageV2() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Parse name into first/last (GHL requires lastName to be a non-empty string)
      const nameParts = formData.fullName.trim().split(' ')
      const firstName = nameParts[0] || 'Unknown'
      const lastName = nameParts.slice(1).join(' ') || firstName // Use first name as last if single name
      ...
      const ghlPayload = {
        ...
        country: formData.country.toUpperCase(), // GHL expects uppercase ISO code
    ...
    <div className={`min-h-screen ${theme.bg} ${theme.text} transition-colors duration-300`}>
      ...
      <div className="relative z-10">
        ...
        <main className="pt-36 pb-20 px-4 sm:px-6 lg:px-8">
          {/* NEW Hero Section - Core Emotional Promise */}
          <div className="max-w-6xl mx-auto mb-16">
            <div className="text-center mb-12">
              <p className="text-xs uppercase tracking-[0.4em] text-[#1d929e] mb-4">You Don&apos;t Need to Work Harder</p>
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight mb-6">
                Replace your manual busywork with a <span className="bg-gradient-to-r from-[#1d929e] to-emerald-400 bg-clip-text text-transparent">24/7 AI team</span>
              </h1>
              <p className={`text-2xl ${theme.textMuted} max-w-3xl mx-auto font-medium`}>
                And finally grow your business without sacrificing your life.
              </p>
            </div>
            ...
            <div className={`max-w-4xl mx-auto text-center mb-12`}>
              <p className={`text-lg ${theme.textMuted}`}>
                All-in-one CRM, automations, follow-up, and live coaching so your business runs smoother, scales faster, and gives you your time back.
              </p>
            </div>

            {/* The Problem - Emotional Insight */}
            <div className={`${isDarkMode ? 'bg-gradient-to-br from-rose-500/10 via-orange-500/10 to-transparent' : 'bg-white shadow-xl'} border ${isDarkMode ? 'border-rose-500/20' : 'border-orange-200'} rounded-3xl p-8 mb-12 max-w-4xl mx-auto`}>
            ...
            <div className={`${isDarkMode ? 'bg-gradient-to-br from-[#1d929e]/20 via-emerald-500/10 to-transparent' : 'bg-white shadow-xl'} border border-[#1d929e]/30 rounded-3xl p-8 mb-12`}>
              ...
              <div className="grid gap-6 md:grid-cols-3 mb-8">
                ...
                <div className={`p-6 rounded-2xl ${isDarkMode ? 'bg-white/5 border border-white/10' : 'bg-gray-50 border border-gray-200'}`}>
                  <Zap className="h-8 w-8 text-[#1d929e] mb-3" />
                  <h3 className="font-bold text-lg mb-2">Systems That Scale</h3>
                  <p className={`${theme.textMuted} text-sm`}>
                    CRM, automations, and content engine that grow your business on autopilot.
                  </p>
                </div>
                <div className={`p-6 rounded-2xl ${isDarkMode ? 'bg-white/5 border border-white/10' : 'bg-gray-50 border border-gray-200'}`}>
                  <Users className="h-8 w-8 text-[#1d929e] mb-3" />
                  <h3 className="font-bold text-lg mb-2">Coaching That Guides</h3>
                  <p className={`${theme.textMuted} text-sm`}>
                    Live support, frameworks, and accountability so you never feel stuck.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-center mb-8">Everything included in your trial</h2>
