...
export function AssessmentPopup() {
  ...
  return (
    <>
      ...
      >
        <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 border border-white/10 rounded-2xl p-8 relative overflow-hidden shadow-2xl">
          {/* Glow blobs */}
          ...
          <div className="relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 text-white py-3.5 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 hover:opacity-90 transition-opacity disabled:opacity-60"
              >
                {isSubmitting ? (
                  'Saving...'
                ) : (
