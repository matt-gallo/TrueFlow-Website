...
export default function ThemePreferenceModal({ onSelectTheme }: ThemePreferenceModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-gradient-to-br from-slate-900 via-black to-slate-900 border border-white/20 rounded-3xl shadow-2xl shadow-blue-500/20 p-8 sm:p-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            >
              <div className="flex flex-col items-center gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-1">Light</h3>
                  <p className="text-sm text-gray-600">Clean & modern</p>
                </div>
              </div>
            ...
            >
              <div className="flex flex-col items-center gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white mb-1">Dark</h3>
                  <p className="text-sm text-white/60">Sleek & focused</p>
                </div>
              </div>
