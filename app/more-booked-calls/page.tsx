/**
 * TrueFlow More Booked Calls Landing Page
 * 2-4x More Booked Calls VSL page
 */
...
const systemBlocks: SystemBlock[] = [
  {
    id: 'speed',
    title: 'Speed: Immediate Response',
    description: 'Every lead gets an instant response the moment they reach out. No delays. No "I\'ll get back to you."',
    icon: Zap,
    gradientFrom: 'from-blue-500',
    gradientTo: 'to-purple-500',
    bullets: [
      'AI responds instantly across all channels',
      'Lead capture from website, chat, DMs, and forms',
      'Faster than any human team could ever be',
      'No more missed opportunities from slow response'
    ]
  },
  {
    id: 'consistency',
    title: 'Consistency: Intelligent Follow-Up',
    description: 'Every lead gets the same high-quality follow-up experience. No one falls through the cracks.',
    icon: Target,
    gradientFrom: 'from-green-500',
    gradientTo: 'to-emerald-500',
    bullets: [
      'Automated follow-up across email, SMS, and chat',
      'Adapts to lead behavior and engagement',
      'No reliance on humans remembering to follow up',
      'Consistent experience for every single lead'
    ]
  },
  {
    id: 'qualification',
    title: 'Qualification Before Booking',
    description: 'Leads are intelligently qualified before they ever hit your calendar. Only high-intent calls get booked.',
    icon: CheckCircle,
    gradientFrom: 'from-purple-500',
    gradientTo: 'to-pink-500',
    bullets: [
      'AI asks the right qualifying questions',
      'Filters out tire-kickers automatically',
      'Books only qualified, ready-to-buy leads',
      'Your calendar fills with better conversations'
    ]
  },
  {
    id: 'ownership',
    title: 'Ownership: We Run It All',
    description: 'You don\'t manage it. You don\'t babysit software. We take full ownership of your backend.',
    icon: Users,
    gradientFrom: 'from-cyan-500',
    gradientTo: 'to-blue-500',
    bullets: [
      'We design, build, and manage everything',
      'Ongoing optimization and support',
      'You focus on sales, we handle the system',
...
export default function VSLPage() {
  ...
  const stats = [
    { value: "2-4×", label: "More booked calls", icon: <TrendingUp className="h-12 w-12" /> },
    { value: "0", label: "Missed opportunities", icon: <Target className="h-12 w-12" /> },
    { value: "Instant", label: "Response times", icon: <Zap className="h-12 w-12" /> },
    { value: "24/7", label: "Systems working", icon: <Clock className="h-12 w-12" /> }
  ]

  const painPoints = [
    'You already have leads coming in constantly',
    'But your calendar isn\'t as full as it should be',
    'Follow-up depends on humans remembering to do things',
    'Some people don\'t get followed up with at all',
    'You know you should be booking way more calls than you are'
  ]

  const softwareProblems = [
    'An immediate response',
    'Intelligent follow-up across channels',
  ...
  const howItWorksSteps = [
    {
      day: 'Step 1',
      title: 'We look at how leads flow through your business',
      description: 'We\'ll analyze your current lead flow and identify exactly where opportunities are being lost.'
    },
    {
      day: 'Step 2',
      title: 'Identify where calls are being lost',
      description: 'We\'ll show you the specific breakdowns in speed, consistency, and qualification that are costing you calls.'
    },
    {
      day: 'Step 3',
      title: 'Show you how this would work in your operation',
      description: 'We\'ll map out exactly how our system would capture, qualify, and book leads automatically in your business.'
    },
    {
      day: 'Step 4',
      title: 'Walk through what it looks like to get started',
      description: 'If it\'s a fit, we\'ll outline the implementation process and what it takes to get your system live.'
    }
  ]

  const offerIncludes = [
    'You already have leads coming into your business',
    'But you feel like you should be booking way more calls',
    'Follow-up is inconsistent or falls apart entirely',
    'You know opportunities are leaking every single day',
    'You want someone else to own the backend completely'
  ]
          ...
          <div className="text-center space-y-6 sm:space-y-8">
            <div>
              <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 mt-8 sm:mt-12 leading-tight px-2 ${
                ...
                2–4× More Booked Calls
                <br />
                <span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
                  Without More Leads or More Staff
                </span>
              </h1>
              ...
              <p className={`text-base sm:text-lg md:text-xl max-w-3xl mx-auto mb-6 sm:mb-8 px-4 ${
                ...
                You don't need more traffic. You don't need a bigger team. If you already have leads coming in but your calendar isn't as full as it should be... watch this.
              </p>
            </div>
          </div>
            ...
            <div className={`backdrop-blur-md rounded-3xl border p-6 sm:p-8 lg:p-10 ${
              ...
              <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
                <iframe
                  ...
                  title="2-4x More Booked Calls Without More Leads"
              ...
              <div className="text-center mt-8">
                <p className={`text-lg sm:text-xl mb-6 ${
                  ...
                  Ready to see how this works in your business?
                </p>
                <button
                  onClick={scrollToBooking}
        ...
        <div className="max-w-4xl mx-auto">
          <div className={`backdrop-blur-md rounded-3xl p-8 sm:p-12 border shadow-2xl ${
            ...
            <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-center leading-tight ${
              ...
              <span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
                The problem isn't traffic. It's that no one truly owns what happens after a lead comes in.
              </span>
            </h2>
      ...
      <section className={`py-16 sm:py-20 px-4 relative ${
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className={`text-lg sm:text-xl text-center mb-8 ${
            ...
            It's not effort. It's not offers. It's that humans are inconsistent.
          </p>
          ...
          <div className={`backdrop-blur-md rounded-3xl p-8 sm:p-12 border shadow-2xl mb-8 ${
            ...
            <div className="space-y-4">
              {softwareProblems.map((problem, index) => (
                ...
                >
                  <div className="flex-shrink-0 mt-1">
                    <CheckCircle className={`h-5 w-5 ${isDarkMode ? 'text-cyan-400' : 'text-cyan-600'}`} />
                  </div>
                  <p className={`text-lg ${isDarkMode ? 'text-white/80' : 'text-gray-700'}`}>
                    {problem}
                  </p>
      ...
      <section className={`py-16 sm:py-20 px-4 relative ${
        ...
        <div className="max-w-4xl mx-auto text-center">
          <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-6 ${
            ...
            <span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
              Getting 2–4× more booked calls comes from speed, consistency, and ownership.
            </span>
          </h2>
          <p className={`text-lg sm:text-xl max-w-3xl mx-auto ${
            isDarkMode ? 'text-white/70' : 'text-gray-600'
          }`}>
            We design, build, and run your entire backend: lead capture, AI-driven follow-up, qualification, and booking. You don't manage it. We own it.
          </p>
        </div>
      </section>
      ...
      <section className={`py-16 sm:py-20 px-4 relative ${
        ...
        <div className="max-w-4xl mx-auto text-center">
          <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-6 ${
            ...
            See exactly how this would work inside your business.
          </h2>

          <p className={`text-lg sm:text-xl mb-8 max-w-3xl mx-auto ${
            isDarkMode ? 'text-white/70' : 'text-gray-600'
          }`}>
            On this call we'll look at how leads are flowing through your business, identify where calls are being lost, and show you how to get 2-4× more booked calls.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className={`backdrop-blur-md rounded-3xl p-8 sm:p-12 border shadow-2xl ${
            ...
            <h2 className={`text-3xl sm:text-4xl font-bold mb-8 text-center ${
              ...
              <span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
                This is for businesses that already have demand
              </span>
            </h2>
            ...
            <div className={`p-6 rounded-2xl text-center ${isDarkMode ? 'bg-white/5' : 'bg-gray-50'}`}>
              <p className={`text-xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                No pressure. No theory. Just clarity.
              </p>
              <p className={`text-lg mt-2 ${isDarkMode ? 'text-white/70' : 'text-gray-600'}`}>
                Book a call and see how this works inside your business.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h2 className={`text-4xl sm:text-5xl md:text-6xl font-bold mb-6 ${
              ...
              You already have the leads. The question is whether your backend is converting them.
            </h2>
            <p className={`text-lg sm:text-xl max-w-3xl mx-auto ${
              isDarkMode ? 'text-white/70' : 'text-gray-600'
            }`}>
            ...
            <div className="flex flex-col lg:flex-row items-stretch gap-6 lg:gap-10">
              <div className="lg:w-5/12 flex flex-col justify-center space-y-4 text-left">
                ...
                <p className={`text-lg leading-relaxed ${isDarkMode ? 'text-white/70' : 'text-gray-600'}`}>
                  On this 30 minute call we'll look at how leads are flowing through your business, identify where calls are being lost, and show you exactly how to get 2-4× more booked calls.
                </p>
