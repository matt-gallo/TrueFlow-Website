/**
 * AI Growth Audit chat page.
 * Hero + the GHL AI chat widget caged inside an iframe so it renders inline
 * within a sized section (instead of floating fixed in the viewport).
 *
 * The iframe loads /ai-growth-audit/chat/embed, which contains only the widget.
 */
...
export default function AiGrowthAuditChatPage() {
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-black text-white' : 'bg-gray-50 text-gray-900'}`}>
      ...
      <nav className="w-full px-4 sm:px-6 lg:px-8 py-5 flex items-center justify-center">
        <Link href="/ai-growth-audit" className="flex items-center">
          <Image
            src={logoSrc}
            alt="TrueFlow"
            width={220}
      ...
      <section className="px-4 pt-4 pb-8 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className={`text-base sm:text-lg max-w-xl mx-auto ${
            ...
            Chat with our AI below to see if you&apos;re a fit and book your call —
      ...
      <section className="px-4 pb-16 flex justify-center">
        <div className={`w-full max-w-md rounded-3xl overflow-hidden border shadow-2xl ${
          ...
          <iframe
            src="/ai-growth-audit/chat/embed"
            title="AI Growth Audit Chat"
