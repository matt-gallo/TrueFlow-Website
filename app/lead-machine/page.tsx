        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm">
              ...
              <Link href="/content-engine" className="text-white/70 hover:text-white transition-colors">Content Machine</Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-black/95 border-t border-white/10">
            <div className="px-4 py-6 space-y-4">
              ...
              <Link href="/content-engine" className="block text-white/80" onClick={() => setIsMenuOpen(false)}>Content Machine</Link>
