/**
 * TrueFlow Core System Page
 * $297/month DIY system with guidance
 */
...
const systemBlocks: SystemBlock[] = [
  {
    ...
    description: 'A production-ready CRM designed to support real sales workflows.',
    icon: Zap,
    gradientFrom: 'from-blue-500',
    gradientTo: 'to-purple-500',
    bullets: [
      'Lead capture from ads, website, chat, forms, and DMs',
      'Custom pipelines aligned to your sales process',
      'Automated follow-up sequences you can edit and control',
      'Clear visibility into every lead and deal'
    ]
  },
  {
    id: 'ai-chat-agents',
    title: 'AI Chat Agents',
    description: 'AI chat agents that respond instantly and route leads properly.',
    icon: MessageSquare,
    gradientFrom: 'from-green-500',
    gradientTo: 'to-emerald-500',
    bullets: [
      '24/7 responses to common questions',
      'Smart scheduling into your calendar',
  ...
  },
  {
    ...
    description: 'A structured content system that keeps you visible without daily effort.',
    icon: FileText,
    gradientFrom: 'from-purple-500',
    gradientTo: 'to-pink-500',
    bullets: [
      'Blog posts, email newsletters, and social content',
      'Editorial calendar and approval workflow',
      'SEO-ready formatting and scheduling',
  ...
  },
  {
    id: 'lead-machine',
    title: 'Lead Machine™',
    description: 'Optional outbound and reactivation systems you can activate when ready.',
    icon: Users,
    gradientFrom: 'from-cyan-500',
    gradientTo: 'to-green-500',
    bullets: [
      'Compliant outbound frameworks',
      'Referral and reactivation campaigns',
      'Funnels and landing pages that connect directly to your CRM'
    ]
  }
]
...
export default function CoreSystemPage() {
  ...
  const painPoints = [
    'You have traffic, referrals, DMs, or inbound interest.',
    'But follow-up is inconsistent.',
    'Leads book… then disappear.',
    'Your CRM exists, but it\'s half-used or ignored.',
          ...
          <div className="text-center space-y-6 sm:space-y-8">
            <div>
              <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 mt-8 sm:mt-12 leading-tight px-2 ${
                ...
                Book sales calls for you without hiring a team.
              </h1>
              ...
              <div className="flex flex-col items-center px-4">
                <Link href="/sign-up">
                  ...
                  >
                    ...
                    <span className="relative z-10">Start the Core System for $297</span>
                ...
                <p className={`text-sm mt-3 ${isDarkMode ? 'text-white/50' : 'text-gray-500'}`}>
                  Instant access · Guided setup · Cancel anytime
                </p>
              </div>
            </div>
          </div>
          ...
          <div className={`backdrop-blur-md rounded-3xl p-8 sm:p-12 border shadow-2xl ${
            ...
            <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-center leading-tight ${
              ...
              <span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
                You already have demand. You just don't have a system.
              </span>
            </h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className={`text-lg sm:text-xl text-center ${isDarkMode ? 'text-white/80' : 'text-gray-700'}`}>
            ...
            <span className="font-bold bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
              Being left alone to figure it all out did.
            </span>
          </p>
        </div>
      </section>
      ...
      <section className={`py-16 sm:py-20 px-4 relative ${
        ...
        <div className="max-w-4xl mx-auto text-center">
          <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-6 ${
            ...
            <span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
              The Core System gives you structure, not chaos.
            </span>
          </h2>
      ...
      <section className={`py-16 sm:py-20 px-4 relative overflow-hidden ${
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h3 className={`text-2xl font-bold mb-4 ${isDarkMode ? 'text-white/70' : 'text-gray-600'}`}>
              One system. Every channel.
            </h3>
            <p className={`text-lg ${isDarkMode ? 'text-white/60' : 'text-gray-500'} mb-6`}>
              Instagram · Facebook · WhatsApp · Email · SMS · Calendars<br/>
              Forms · Pipelines · Automations · Content · Reporting
            </p>
      ...
      <section className={`py-16 sm:py-20 px-4 relative ${
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href="/sign-up">
            ...
            >
              <span>Start the Core System for $297</span>
