      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none text-gray-600">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Our Property</h3>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">10. Data Processing and Privacy</h2>
            <p>
