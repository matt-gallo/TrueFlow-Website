...
const solutionProducts: SolutionProduct[] = [
  {
    ...
    bullets: [
      ...
      'Email & SMS Automation - nurture leads and clients automatically throughout the case lifecycle',
      'Reputation Management - collect 5-star reviews from satisfied clients',
      'Analytics & Reporting - know exactly what\'s working (lead sources, conversion rates, cases closed)'
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      'Instant responses to common questions about practice areas, legal services, and case process',
      'Qualify potential clients automatically before they reach you'
    ],
    hook: 'Prospects visit your site but leave without booking because no one\'s there to help them.',
    story: 'Our AI agents are trained on your law practice and available round-the-clock. They answer questions about your services, qualify prospects, and book consultations directly into your calendar while you sleep.',
    offer: 'AI agents that work 24/7 to capture and qualify leads, turning website visitors into booked consultations.',
    offerHighlights: ['Custom AI training on your practice areas', '24/7 lead capture and qualification', 'Direct calendar integration'],
    ctaHref: '/sign-up'
  },
  {
    id: 'content-engine',
          ...
          <div className="text-center space-y-6 sm:space-y-8">
            <div>
              ...
              <p className={`text-base sm:text-lg md:text-xl max-w-3xl mx-auto mb-6 sm:mb-8 px-4 ${
                ...
                Done-for-you CRM, automated follow-up, scheduling, and marketing systems built for law offices - so every lead turns into a booked consultation without attorney involvement.
              </p>
          ...
          <div className={`backdrop-blur-md rounded-3xl p-8 sm:p-12 border shadow-2xl ${
            ...
            <div className="grid gap-4 sm:gap-6 max-w-3xl mx-auto">
              {[
                ...
                "Leads book consultations… then no-show.",
                "Potential clients fill out contact forms… then disappear.",
                "Messages sit unanswered while you're in court.",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            ...
            <p className={`text-lg md:text-xl mb-8 max-w-3xl mx-auto ${
              ...
              Book a demo to see how we handle setup, management, and optimization while you stay focused on winning cases and serving clients.
            </p>
            <button
              onClick={() => setIsDemoModalOpen(true)}
