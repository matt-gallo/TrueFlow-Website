...
const solutionProducts: SolutionProduct[] = [
  {
    ...
    bullets: [
      'Trial and intro capture from forms, ads, chat, website, and DMs.',
      'Full CRM & Pipeline Management - never lose a trial or member again',
      'Email & SMS Automation - nurture trials and members automatically',
      'Reputation Management - collect 5-star gym reviews',
  ...
  },
  {
    ...
    bullets: [
      'AI Chat Agents - book intros 2-3x faster, 24/7',
      'Smart scheduling - members book intro sessions directly into your calendar',
      'Instant responses to common questions',
      'Qualify trials automatically before they reach you'
    ],
    hook: 'Prospects visit your site but leave without booking because no one\'s there to help them.',
    story: 'Our AI agents are trained on your gym and available round-the-clock. They answer questions, qualify prospects, and book intro sessions directly into your calendar while you sleep.',
    offer: 'AI agents that work 24/7 to capture and qualify trials, turning website visitors into booked intro sessions.',
    offerHighlights: ['Custom AI training on your gym', '24/7 trial capture and qualification', 'Direct calendar integration'],
    ctaHref: '/sign-up'
  },
  {
    id: 'content-engine',
  ...
  },
  {
    ...
    name: 'Lead Machine™',
    title: 'Lead Machine™',
    description: "Finds new gym members for you with targeted outreach done right.",
    icon: Users,
  ...
  const features = [
    {
      ...
      title: "Never Miss a Trial Again",
      description: "We build systems that capture every trial and intro and follow up automatically. Text, email, or call - your prospects hear back fast, even when you're coaching.",
    ...
    },
    {
      ...
      title: "24/7 Member Communication",
      description: "Answer common questions, schedule intro sessions, and update members automatically. Give great service without lifting a finger.",
    ...
    },
    {
      ...
      description: "Automatic intro session scheduling, confirmations, and reminders reduce no-shows. Keep your calendar full without the back-and-forth.",
    ...
    },
    {
      ...
      description: "We create and post content that brings in new members. Stay top-of-mind without spending hours on Facebook and Instagram.",
          ...
          <div className="text-center space-y-6 sm:space-y-8">
            <div>
              <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 mt-8 sm:mt-12 leading-tight px-2 ${
                ...
                Add 10 new members per month on autopilot
              </h1>

              <p className={`text-base sm:text-lg md:text-xl max-w-3xl mx-auto mb-6 sm:mb-8 px-4 ${
                isDarkMode ? 'text-white/60' : 'text-gray-600'
              }`}>
                Done-for-you CRM, automated follow-up, scheduling, and marketing systems built for CrossFit and functional fitness gyms - so every lead turns into a booked intro without owner involvement.
              </p>
          ...
          <div className={`backdrop-blur-md rounded-3xl p-8 sm:p-12 border shadow-2xl ${
            ...
            <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-12 text-center leading-tight ${
              ...
              <span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">
                Every missed follow-up is lost membership revenue you already paid for
              </span>
            </h2>
            ...
            <div className="grid gap-4 sm:gap-6 max-w-3xl mx-auto">
              {[
                ...
                "Trials fill out forms… then disappear.",
                "Messages sit unanswered while classes are running.",
                "Slow follow-up costs memberships."
              ].map((point, index) => (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            ...
            <p className={`text-lg md:text-xl mb-8 max-w-3xl mx-auto ${
              ...
              Book a demo to see how we handle setup, management, and optimization while you stay focused on coaching and running your gym.
            </p>
            <button
              onClick={() => setIsDemoModalOpen(true)}
              ...
              <div className={`relative flex gap-6 p-6 rounded-2xl border ${
                ...
                <div className="flex-1">
                  ...
                  <h4 className={`text-xl font-bold mb-2 ${
                    ...
                    You See Where Every Trial Goes
                  </h4>
